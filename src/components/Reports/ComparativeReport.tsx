...
const ComparativeReport: React.FC<ComparativeReportProps> = ({
    ...
    const getReportData = useCallback(() => {
        ...
        if (reportType === "period") {
            ...
            if (data.length === 0) {
                data = [
                    ["São Paulo", "Sudeste", "3.250", "15", "216,7 kg"],
                    ["Rio de Janeiro", "Sudeste", "2.840", "12", "236,7 kg"],
                    ["Belo Horizonte", "Sudeste", "2.100", "10", "210,0 kg"],
                ];
            }
            ...
            if (data.length === 0) {
                data = [
                    ["João Silva", "São Paulo", "850", "R$ 17.000,00", "R$ 20,00"],
                    [
                        "Maria Oliveira",
                        "Rio de Janeiro",
                        "720",
            ...
            if (data.length === 0) {
                data = [
                    ["Âmbar Claro", "2.500", "35%", "R$ 22,50"],
                    ["Âmbar", "1.800", "25%", "R$ 21,00"],
                    ["Âmbar Escuro", "1.400", "20%", "R$ 19,50"],
                ];
            }
        }
