...
const SupabaseConfig: React.FC<SupabaseConfigProps> = ({ onConfigured }) => {
    ...
    const testConnection = async () => {
        if (!supabaseUrl || !supabaseKey) {
            setErrorMessage("URL e chave do Supabase são obrigatórios");
            setTestStatus("error");
            return;
        }
                    ...
                    <TabsContent value="help" className="space-y-4">
                        <div className="space-y-4">
                            ...
                            <ol className="list-decimal pl-5 space-y-2">
                                ...
                                <li>Vá para o Editor SQL no Supabase</li>
                                <li>Cole o script SQL da aba Esquema SQL e execute-o</li>
                                <li>Teste a conexão na aba Configuração</li>
                            </ol>

                            <h3 className="text-lg font-medium mt-6">
                                Estrutura do Banco de Dados
                            </h3>
                            <p>O banco de dados contém as seguintes tabelas:</p>
